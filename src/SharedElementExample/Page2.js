    ...
    render() {
        return (
            <div style={this.props.style} ref={this.props.innerRef}>
                <img id="hero" className='example-image2' src='https://68.media.tumblr.com/4d1f173744a32bb4b35a2d5d0babff74/tumblr_mnh29fxz111st5lhmo1_1280.jpg' />
                ...
                <img id="another-one" className='example-image2' src='https://wefunction.com/wordpress/wp-content/uploads/2013/10/tumblr_ms9mpnB2o61st5lhmo1_1280.jpg' />
            </div>
        );
    }
}

const codeString = `class Page2 extends React.Component {
    render() {
        return (
            <div style={this.props.style} ref={this.props.innerRef}>
                <img id="hero" className='example-image2' src='https://68.media.tumblr.com/4d1f173744a32bb4b35a2d5d0babff74/tumblr_mnh29fxz111st5lhmo1_1280.jpg' />
